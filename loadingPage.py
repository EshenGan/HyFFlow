...
startbutton = Button(loadroot, text="HOME", height="5", width="40", bg="lightblue", fg="black",command=lambda: mn.loadpackages(loadroot))
...
guidebutton = Button(loadroot, text="EXIT", height="5", width="40", bg="lightblue", fg="black",command=Exit)
