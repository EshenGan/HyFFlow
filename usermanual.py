...
def openguide(loadroot):
    ...
    can1.pack()
    img1 = ImageTk.PhotoImage(Image.open(r"selectfile.png"))
    can1.place(x=0,y=30)
    ...
    can2.pack()
    img2= ImageTk.PhotoImage(Image.open(r"scanfiles.png"))
    ...
    can3.pack()
    img3=ImageTk.PhotoImage(Image.open(r"formatofdata.png"))
    ...
    can4.pack()
    img4= ImageTk.PhotoImage(Image.open(r"selectmedian.png"))
    ...
    can5.pack()
    img5= ImageTk.PhotoImage(Image.open(r"selstation.png"))
    ...
    can6.pack()
    img6= ImageTk.PhotoImage(Image.open(r"man-kendall.png"))
